---
title: "Building More Gracious and Harmonious Communities: Facilitating Effective Resolution of Neighbour Disputes"
...
{:start=“8”}
8.&nbsp;&nbsp;&nbsp; A summary of the main feedback received, together with the ministries’ response, has been published on REACH’s website at <a href="https://www.reach.gov.sg/Participate/Public-Consultation/Ministry-of-Culture-Community-and-Youth/public-consultation-paper-on-the-proposed-enhancements-to-the-community-dispute-management-framework">www.go.gov.sg/feedbackcdmf</a>. The feedback from the consultation and engagement sessions have been instrumental to the CDMF review, and we would like to take this opportunity to thank all participants for their contributions.

**CDMF enhancements to further strengthen community and maintain harmonious living**
...
{:start=“10”}
10.&nbsp;&nbsp;&nbsp; <b>These enhancements will strengthen, not replace, the ability of the community to come together early and resolve their differences as good neighbours.</b> Through the Amendment Bill, we aim to facilitate gracious and harmonious living through three enhancements to the CDMF:

<p style="margin-left: 40px">
a. &nbsp; <b>Encouraging the increased use of community mediation to resolve neighbour disputes at an early stage:</b> Authorised agencies may direct parties to attend mediation at the CMC to resolve neighbour disputes, including noise-related disputes. The CMC has also set up more satellite mediation venues at selected community clubs and Service SG centres to improve access to mediation.</p>
...
<p style="margin-left: 40px">
c. &nbsp; <b>Enhancing the processes and powers of the Community Disputes Resolution Tribunals (CDRT):</b> The CDRT remains an avenue of last resort for cases where earlier intervention by the CRU and community
mediation have not resolved the neighbour dispute. The CDRT will be able
to consider all relevant evidence that CRU officers have gathered in the course of investigations and will also be empowered to make new orders
such as interim orders and mandatory treatment orders. This will facilitate
quicker and more effective resolution of cases that are brought before the
tribunal.</p>

{:start=“11”}
11.&nbsp;&nbsp;&nbsp; The details of the three CDMF enhancements are outlined in the following paragraphs.

**Encouraging the use of community mediation to resolve disputes amicably**

{:start=“12”}
12.&nbsp;&nbsp;&nbsp; Community mediation is a quick, low-cost and effective way to help neighbours reach an amicable resolution to their disputes. Today, about 80% of voluntary mediation cases mediated by the CMC are successfully settled: Many of these neighbours who attempted mediation with the assistance of trained mediators, were able to find a mutual compromise beneficial to all parties. However, despite its
effectiveness, many parties in dispute are unwilling to attempt mediation. Less than 30% of the total cases registered at the CMC proceed to mediation because one party does not wish to participate in mediation.

{:start=“13”}
13.&nbsp;&nbsp;&nbsp; The Bill will extend the benefits of mediation to more disputes<sup><a href="#fn1" id="ref1">1</a></sup>, by empowering agencies (such as the CRU and the CMC) to direct disputing parties to
attend mediation at the CMC by issuing a Mediation Direction. Disagreements are more likely to be resolved when parties take time and effort early on to hear each other’s views and perspectives and work through their differences, with the help of trained mediators. For a start, the Mediation Direction framework will be piloted together with the CRU, to resolve suitable disputes over noise.
...
**Community Relations Unit (CRU) Pilot to address severe neighbour noise and hoarding cases**

{:start=“15”}
15.&nbsp;&nbsp;&nbsp; To better address severe neighbour noise disputes, we will pilot a dedicated unit. The CRU will be given regulatory powers to intervene in severe cases of noise-related neighbour disputes. The pilot will run for a year initially in the HDB estates of one to two towns, starting with Tampines. Agencies will review the scope and resources required thereafter, to assess whether and how it can be sustainably scaled up island-wide<sup><a href="#fn2" id="ref2">2</a></sup>. The CRU will be an important part of the overall CDMF, and step in only after neighbours’ attempts to resolve the disputes amongst themselves have failed.

{:start=“16”}
16.&nbsp;&nbsp;&nbsp; The CRU will be staffed by Community Relations Officers (CROs), who have experience in law enforcement and basic mediation, and have passed strict background checks. The CROs will be supported by auxiliary police officers, termed Auxiliary CROs. CROs and Auxiliary CROs are required to identify themselves in the course of duty. Members of public can also verify their identity via an <a href="https://www.mnd.gov.sg/verification-of-community-relations-officers">MND webpage</a>.
...
<p style="margin-left: 40px">
a. &nbsp; Take statements from the neighbours concerned, and others who can help with the investigation;
</p>

<p style="margin-left: 40px">
b. &nbsp; Enter a place of residence to gather evidence, with the consent of the owner, occupier, or with approval from the Director-General of Community Relations;</p>

<p style="margin-left: 40px">
c. &nbsp; Issue a mediation direction to require the neighbours concerned to attend mediation, if the case is found suitable for mediation;</p>

<p style="margin-left: 40px">
d. &nbsp; Issue advisories, warnings or abatement orders that require the individual to take reasonable steps to stop the noise nuisance; and</p>

<p style="margin-left: 40px">
e. &nbsp; Require the removal of the nuisance-causing object, after sufficient warning and with authorisation from the Director-General.</p>

(Please refer to <u>Annex A</u> for the proposed offences and penalties.)

{:start=“18”}
18.&nbsp;&nbsp;&nbsp; In addition, the CRU will be empowered to deploy noise sensors, to collect objective evidence on the direction, timing and intensity of the noise. This addresses the current gap where sound recordings made by complainants are often not useful for the purposes of determining the volume (as playback can be distorted) or source
of noise. The CRU intends to use noise sensors as a confirmatory tool, after CRU’s initial investigations narrow down the residential unit the noise nuisance might be coming from, and neighbours have been given opportunity to share their perspectives and work through differences. Taking in feedback from the public consultations and stakeholder engagements, we have developed the following operational framework to safeguard resident privacy:

<p style="margin-left: 40px">
a. &nbsp; The noise sensor data will be transmitted in real-time to Singapore-based servers with strict access controls for <u>processing</u> only.</p>

<p style="margin-left: 40px">
b. &nbsp; The raw recordings of the noise (e.g. loud conversations or loud noises) will <u>not</u> be stored. CRU officers will not be able to listen to any raw recordings of the noise.</p>

<p style="margin-left: 40px">
c. &nbsp; The noise sensors will only be deployed with the consent of the owner or occupier of the affected units or, if the noise sensors are deployed in common areas (e.g. corridors), the managing agents. If complainants do not give consent, the CRU will not deploy the sensors.</p>

<p style="margin-left: 40px">
d. &nbsp; The use of noise sensors will be an option for parties to prove their case, and not a requirement. This is particularly important as there have been times where the noise source turns out to be different from what the complainant originally thought it was, a learning point from the Noise
Experiential Lab which was mooted by the Community Advisory Panel on
Neighbourhood Noise and which the Municipal Services Office (MSO) ran
from September 2023 to January 2024.</p>

(Please refer to <u>Annex B</u> for details on how the noise sensors would be used.)
...
(Please refer to <u>Annex C</u> for actual, anonymised cases of severe noise-related neighbour disputes and how the CRU could help with such cases going forward.)

{:start=“20”}
20.&nbsp;&nbsp;&nbsp; Lastly, to address severe in-unit hoarding, the CRU can apply for a CDRT order to declutter a residential unit, after the CDRT is satisfied that the hoarding has caused unreasonable interference to the hoarder’s neighbour <u>and</u> the hoarder has not complied with an initial CDRT order to declutter. This again is a measure of last resort, premised on public interest, after existing regulatory levers from frontline agencies have been exhausted.

**Enhancing the processes and powers of the CDRT to deliver faster and more effective relief**

{:start=“21”}
21.&nbsp;&nbsp;&nbsp; In the course of the public consultation exercise, some members of the public expressed concern that CDRT proceedings (which are court proceedings) are not able to address the root cause of neighbour disputes, and can be damaging to neighbourly relations. At the same time, respondents accepted that CDRT proceedings may be necessary for serious cases; and supported the proposal to enhance the range of orders that the CDRT can make.
...
{:start=“25”}
25.&nbsp;&nbsp;&nbsp; More details on the specific enhancements to the CDRT’s powers and processes are set out in <u>Annex D</u>.

**Concerted effort and commitment on the part of every individual**

{:start=“26”}
26.&nbsp;&nbsp;&nbsp; Good neighbours should come together early and often. Such ties go a long way to building social capital that can weather everyday frictions..
...
<p><sup id="fn1">1. In particular, this includes cases where the party did not think mediation would work, or that there was any issue to mediate. It could also include those where parties had previously reached a settlement through voluntary mediation, but the dispute resurfaced.</sup><a href="#ref1" title="Jump back to footnote 1 in the text." style="font-size: 12px">↩</a></p>
<p><sup id="fn2">2. Tampines was chosen as the pilot site as it has an average caseload compared to other towns. As the pilot is to help with design and resourcing of the CRU model, we need a pilot site with average load so that our experience and learnings will be more representative of the national picture.</sup><a href="#ref2" title="Jump back to footnote 2 in the text." style="font-size: 12px">↩</a></p>

**Annex A** [Proposed Offences and Penalties](/files/news/press-releases/2024/CDMF_AnnexA.pdf)
<br>**Annex B** [How the Noise Sensors Would Be Used](/files/news/press-releases/2024/CDMF_AnnexB.pdf)
<br>**Annex C** [Actual, Anonymised Cases of Severe Noise-Related Neighbour Disputes and How the CRU Could Help](/files/news/press-releases/2024/CDMF_AnnexC.pdf)
<br>**Annex D** [Key Enhancements to the Powers and Processes of the Community Disputes Resolution Tribunals (CDRT)](/files/news/press-releases/2024/CDMF_AnnexD.pdf)
...
<p class="right-side-updated">Last updated on 12 August 2024</p>
