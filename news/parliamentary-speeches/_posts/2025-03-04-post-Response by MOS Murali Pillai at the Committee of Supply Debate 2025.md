...
{:start="2"}
2. The Singapore Land Authority (SLA) ensures effective and imaginative use of land resources.
...
{:start="6"}
6. Besides optimising the use of State assets, we are harnessing technology to digitalise transactions.

{:start="7"}
7.  Singapore's current conveyancing system is reliant on physical documents and processes, and requires significant manpower.

{:start="8"}
8. SLA has therefore been developing the Digital Conveyancing Portal (DCP). It is a fully integrated, digital end-to-end conveyancing process for all types of property: from the stage of Option to Purchase (OTP) to Legal Completion. It will also enable e-payments and digital documents.

{:start="9"}
9. When operationalised, the DCP will provide greater convenience to all parties, including buyers and sellers, law firms, real estate professionals, financial institutions, and developers.

{:start="10"}
10. We are testing the system rigorously and seeking industry feedback, including on how the phases of the DCP should be prioritised and the continuing evolution of associated technology.

{:start="11"}
11. The first phase of the DCP focuses on private residential resale transactions, which make up more than half of private real estate transactions. Beta testing of the OTP process started in November 2024 with selected stakeholders. Live OTP transactions for the private residential resale market is targeted to commence, as a pilot initially, in 2025.

{:start="12"}
12. The DCP functions and types of transactions will be progressively expanded in subsequent phases.

<b><u>II. DEVELOPING NEW MEASURES TO BENEFIT FROM EMERGING TECHNOLOGIES WHILE ENSURING ADEQUATE SAFEGUARDS</u></b>

**A. Maintaining a robust and balanced IP regime that supports creativity and innovation**

{:start="13"}
13. Even as technology becomes integral, we are aware that it also presents issues, particularly with copyright.

{:start="14"}
14. Our intellectual property (IP) regime incentivises the creation of new works by rewarding creators with a set of rights over the use of their works. At the same time, allows reasonable access to these works by third parties, including other creators and innovators who may build on them.

{:start="15"}
15. In this way, we maximise creative and innovative output through a balanced approach.

{:start="16"}
16. Ms Sylvia Lim, Ms Jean See asked about the balance in the context of AI.
...
{:start="21"}
21. We are also focused on the impact of technology in the legal sector.

{:start="22"}
22. Legal professionals should use GenAI tools safely and responsibly, even as we encourage its adoption.
...
{:start="27"}
27. Mr Lim Biow Chuan, Mr Vikram Nair, Mr Zhulkarnain and Ms Nadia Samdin asked about the Government’s efforts to combat online harms.
...
{:start="40"}
40. Since the amendment was implemented in August 2024, more than 100 accused persons have been released on personal bond for non-bailable offences.

{:start="41"}
41. The personal bond regime is new and is in infancy. We will continue to keep our policies on remand and bail under review.

<b><u>VI. IMPROVING LEGAL PROCESSES FOR SINGAPOREANS</u></b>
	
**A. Access to Justice and the Digital Divide**
