...
If the Applicant or Respondent wishes to extend the period within which they are required to serve or submit any form or document, they may make a request to the Registrar, or the Assessor if one has been appointed, by way of email. If there is no ongoing email correspondence with the Registry, please email the Registry at [covid19-registry@mlaw.gov.sg](mailto:covid19-registry@mlaw.gov.sg).
