...
<mark style="background-color: lightblue">Marked text</mark>**Before serving the Notice of Negotiation, the Affected Business should prepare the supporting documents (set out [here](https://go.gov.sg/re-align-eligibility-supportingdocs)) which should be enclosed to the Notice of Negotiation.**
